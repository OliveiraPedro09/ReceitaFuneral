...
const LoginScreen = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <Text style={styles.title}>Seja Bem-Vindo ao Receita Funeral !</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: "bold", marginBottom: 20, textAlign: "center", color: "#F39237" },
  ...
  button: { backgroundColor: "#F39237", padding: 12, borderRadius: 20, width: "50%", alignItems: "center" },
